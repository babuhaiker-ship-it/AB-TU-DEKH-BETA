...
# --- NEW: Lifespan Manager for Startup/Shutdown ---
@asynccontextmanager
async def lifespan(app_fastapi: FastAPI):
    """
    Handles startup and shutdown events for the FastAPI application.
    """
    global app, session_string
    logger.info("Lifespan startup: Initializing Pyrogram client and background tasks...")
    ...
    if not session_string:
        ...
        logger.info("A new Pyrogram session string was generated and saved to the database.")
