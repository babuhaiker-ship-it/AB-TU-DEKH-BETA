...
class BotConfig:
    ...
    MINI_APP_URL = os.environ.get("STREAM_BASE_URL", "http://localhost:8000") # Frontend and Backend are on the same domain # MODIFIED
