...
class BotConfig:
    ...
    JWT_SECRET_KEY = os.environ.get("JWT_SECRET_KEY", "a_super_secret_default_key_that_should_be_changed")
...
# --- Web Access Token Management (JWT) ---
...
async def webui_cmd(client: Client, message: Message):
    ...
    payload = {
        'user_id': user_id,
        'exp': datetime.utcnow() + timedelta(seconds=WEB_TOKEN_EXPIRY_SECONDS)
    }
