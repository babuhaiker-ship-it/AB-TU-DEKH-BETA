...
class BotConfig:
    ...
    MINI_APP_URL = "https://niggabitchass.onrender.com" # IMPORTANT: Replace with your actual frontend URL
...
async def get_api_stream_url(video_uuid: str, auth: dict = Depends(verify_telegram_init_data)):
    ...
    try:
        file_obj = await app.get_file(file_id)
        ...
        try:
            ...
            file_obj = await app.get_file(new_file_id)
            if not file_obj or not file_obj.file_path:
